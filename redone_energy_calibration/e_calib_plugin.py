...
def do_rebin(filename, bin_size, keep_edges=True, save=False, plot=False, relpath="Z:/Studenten/Baier/Messungen/sortme/"):
    ...
    if keep_edges:
        ...
        bins = np.arange(0, len(bins[::bin_size]), 1)
    ...
    if save:
        ...
        np.savetxt(relpath + filename.rstrip(".txt") + "_rebin" + str(bin_size) + ".txt", save_array, delimiter=";")


c.c_file.sort_to_dirs()
"""names = c.search_in_dir("data/sev", identifiers=["binning1"])
for name in names:
    print(name)
    if "dsf" in name:
        do_rebin(name, 25, plot=False, save=True, keep_edges=True, relpath="C:/Users/baier/OneDrive/Uni/Bachelorarbeit/sortme/")
    else:
        do_rebin(name, 150, plot=False, save=True, keep_edges=True, relpath="C:/Users/baier/OneDrive/Uni/Bachelorarbeit/sortme/")
"""
#
do_rebin("sev_ebis110_bng2s111_am241_10cm_100s_hight_hist_dosibinning1.txt", 150, plot=False, save=True, keep_edges=True, relpath="C:/Users/baier/OneDrive/Uni/Bachelorarbeit/sortme/")
# do_rebin("sev_pvcebis110_bng2s103_cm244_10cm_100s_hight_hist_dosibinning1", 150, plot=True, save=False, keep_edges=False)
